		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comappzuiplanningcalender-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappzuiplanningcalender-display": {
								"semanticObject": "comappzuiplanningcalender",
								"action": "display",
								"description": "Planning Calender",
								"title": "Planning Calender",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.zuiplanningcalender",
									"url": sap.ui.require.toUrl("com/app/zuiplanningcalender")
								}
							}
						}
					}
